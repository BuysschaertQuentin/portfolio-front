...
const softSkills: readonly SoftSkill[] = [
  {
    icon: Heart,
    label: "Empathie",
    desc: "Écoute active et bienveillance au quotidien",
  },
  {
    icon: Shield,
    label: "Résilience",
    desc: "Gestion du stress et adaptation permanente",
  },
  {
    icon: Clock,
    label: "Gestion des priorités",
    desc: "Organisation rigoureuse et autonomie",
  },
  {
    icon: Users,
    label: "Travail d'équipe",
    desc: "Collaboration avec familles et professionnels",
  },
];

const SoftSkillCard = ({ icon: Icon, label, desc }: SoftSkill) => (
  ...
  <section id="past" className="relative">
    ...
    <div className="section-container relative z-10">
      ...
      <h2 className="text-3xl sm:text-4xl font-bold mb-12 text-glow-cyan">
        Auxiliaire de vie — <span className="text-cyan">8 ans d'humanité</span>
      </h2>
        ...
        <div className="space-y-6">
          <div className="glass-card rounded-xl p-8 border-cyan/20 space-y-4">
            <p className="text-secondary-foreground leading-relaxed">
              Pendant 8 ans, j'ai accompagné des personnes vulnérables au
              quotidien. Cette expérience profondément humaine m'a doté de
              compétences transversales qui font aujourd'hui ma force en tant
              que développeur.
            </p>
          </div>
