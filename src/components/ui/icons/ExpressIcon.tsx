...
/**
 * Express.js brand icon — black version on white background.
 * SVG path sourced from Devicons (https://devicons.github.io/devicon/).
 */
const ExpressIcon = (props: ComponentPropsWithoutRef<"svg">) => (
  <svg
