export const reposCompensateursFr = {
  title: "Module Microservice RH — Temps Partiels & Repos Compensateurs",
  shortDesc: "Module microservice d'entreprise de gestion des régimes de temps partiels et repos compensateurs — Angular 18, Java 17, Spring Boot 3.",
  definition:
    "Le **Module Microservice RH** (dédié aux Temps Partiels & Repos Compensateurs) est une application d'entreprise stratégique développée au sein d'Orange Business. Il s'intègre dans un écosystème distribué de plusieurs microservices dédiés à la gestion des régimes de travail des salariés (temps partiels parentaux, règles d'aménagement du temps de travail, justificatifs) et au suivi des soldes de repos compensateurs.",
  framing:
  ...
  tabs: {
    ...
    situation1: {
      ...
      framing:
        "Lorsqu'il m'a été confié la création du nouveau Module Microservice RH en 2025, l'interface utilisateur n'existait pas. Mon objectif était de concevoir l'intégralité du Front-End sous **Angular 18** en appliquant les normes de qualité logicielle les plus exigeantes d'entreprise.",
      action:
...
export const reposCompensateursEn = {
  ...
  tabs: {
    ...
    situation1: {
      ...
      framing:
        "When I was entrusted with creating the new HR Microservice Module in 2025, the user interface did not exist. My goal was to engineer the complete Front-End using **Angular 18** while adhering to strict enterprise code quality standards.",
      action:
